...
public class ToItalianMessage implements Observer{
	...
	public void translate() {
		...
		System.out.println("S-a tradus mesajul primit in italiana");
	}
	public String toString() {
		
		return " --> observator italiana";
	}
}
