...
public class ToEnglishMessage implements Observer{
	...
	public void translate() {
		...
		System.out.println("S-a tradus mesajul primit in engleza");
	}
	public String toString() {
		
		return " --> observator engleza";
	}
}
